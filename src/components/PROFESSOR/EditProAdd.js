...
import assignAllSubjects from "../assignAllSubjects";
...
function EditProAdd() {
    ...
    return (
        <div>
            <h4 style={{ margin: "30px" }}>AÑADIR ASIGNATURAS A :  {from} </h4>
            <Button onClick={()=> assignAllSubjects( arrId, from ) } >Asignar asignaturas</Button>
