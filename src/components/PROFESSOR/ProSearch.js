...
import ProFiltrada from './ProFiltrada';
...
function ProSearch() {
    ...
    function submitForm(e) {
        ...
        const url = "http://localhost:8080/bahut/v1/professor/some";
    ...
    function submitId(e) {
        ...
        const url = "http://localhost:8080/bahut/v1/professor/" + input.value;
